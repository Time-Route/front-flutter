...
class mNode {
  ...
  mNode({required this.id, required this.position});
}
...
final List<mNode> nodes = [
  mNode(id: '어의관', position: LatLng(37.635339, 127.076869)),
  mNode(id: '국제관', position: LatLng(37.634740, 127.077435)),
  mNode(id: "창조관", position: LatLng(37.634474, 127.079266)),
  mNode(id: '다빈치관', position: LatLng(37.634559, 127.078100)),
  mNode(id: '정류장', position: LatLng(37.6341, 127.0779)),
  mNode(id: '창학관1', position: LatLng(37.6327, 127.0788)),
  mNode(id: "창학관2", position: LatLng(37.632089, 127.079380)),
  mNode(id: '하이테크관', position: LatLng(37.631994, 127.077103)),
  mNode(id: "향학로 끝", position: LatLng(37.633044, 127.077491)),
  mNode(id: "프론티어관", position: LatLng(37.631301, 127.076853)),
  mNode(id: "창학관 사거리", position: LatLng(37.631598, 127.079166)),
  mNode(id: "계단", position: LatLng(37.631325, 127.079658)),
  mNode(id: "혜성관", position: LatLng(37.631420, 127.081836)),
  mNode(id: "상상관", position: LatLng(37.631078, 127.079600)),
  mNode(id: "테크노큐브", position: LatLng(37.630138, 127.079445)),
  mNode(id: "미래관", position: LatLng(37.629455, 127.081018)),
  mNode(id: "상상무궁사이", position: LatLng(37.631160, 127.080534)),
  mNode(id: "무궁관", position: LatLng(37.631122, 127.080942)),
  mNode(id: "아름관", position: LatLng(37.630108, 127.080280)),
  mNode(id: "청운관", position: LatLng(37.633243, 127.080692)),
  mNode(id: "미래아름", position: LatLng(37.629595, 127.080141)),
  mNode(id: "무궁관 삼거리", position: LatLng(37.631053, 127.081492)),
  mNode(id: "무궁관 다리 앞", position: LatLng(37.631002, 127.081814)),
  mNode(id: "다산-창학", position: LatLng(37.631812, 127.078466)),
  mNode(id: "창조-청운", position: LatLng(37.634158, 127.079398)),
  mNode(id: "파워플랜트", position: LatLng(37.6335, 127.07895)),
];
...
double calculateEdgeLength(Edge edge) {
  return edge.coordinates.sublist(0, edge.coordinates.length - 1).fold<double>(0, (length, coordinate) => length + calculateDistance(coordinate, edge.coordinates[edge.coordinates.indexOf(coordinate) + 1]));
}
...
List<Edge> dijkstra(Graph graph, String startNodeId, String endNodeId) {
  ...
  PriorityQueue<mNode> queue = PriorityQueue((a, b) => (distances[a.id] ?? double.infinity).compareTo(distances[b.id] ?? double.infinity));
  queue.add(graph.nodes.firstWhere((node) => node.id == startNodeId));

  while (queue.isNotEmpty) {
    mNode u = queue.removeFirst();
